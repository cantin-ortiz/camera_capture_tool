@echo off
REM Open Ephys Synchronisation Testing Tool Launcher
REM This script activates the Python virtual environment and starts the testing program

echo ========================================
echo    Camera-Ephys Synchronisation Test
echo ========================================
echo.
...
:skip_venv
echo Starting synchronisation test...
echo.

REM Run the testing script with all arguments passed to the batch file
